...
<body class="bg-white text-gray-800 font-sans">
    ...
    <nav class="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            <span class="text-teal-700 font-bold text-xl tracking-tight">🕌 Walisantri.com</span>
            ...
            <div class="flex gap-3">
                <a href="{{ route('login') }}"
                   class="text-sm text-gray-600 hover:text-teal-700 font-medium px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors">
                    Masuk
                </a>
                <a href="{{ route('register') }}"
                   class="text-sm bg-teal-700 text-white font-medium px-4 py-2 rounded-lg hover:bg-teal-800 transition-colors">
                    Daftar Gratis
                </a>
            </div>
        </div>
