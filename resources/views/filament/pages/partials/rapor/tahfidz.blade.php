    ...
    @else
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 p-5">
            <div class="text-center">
                ...
                <p class="text-lg font-bold text-gray-900 dark:text-gray-100">{{ $stats['total_setoran'] }}</p>
            </div>
            <div class="text-center">
                <p class="text-xs text-gray-400 mb-1">Total Juz</p>
                <p class="text-lg font-bold text-gray-900 dark:text-gray-100">{{ $stats['total_juz'] }}</p>
            </div>
            <div class="text-center">
                <p class="text-xs text-gray-400 mb-1">Hari Aktif</p>
                <p class="text-lg font-bold text-gray-900 dark:text-gray-100">{{ $stats['hari_aktif'] }}</p>
            </div>
            @foreach($stats['per_tipe'] as $tipe => $detail)
            <div class="text-center">
                <p class="text-xs text-gray-400 mb-1">{{ $tipe }}</p>
                <p class="text-lg font-bold text-gray-900 dark:text-gray-100">{{ $detail['jumlah'] }}</p>
                <p class="text-[11px] text-gray-400">{{ $detail['halaman'] }} hal.</p>
            </div>
            @endforeach
        </div>
